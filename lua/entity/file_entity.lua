...
function FileEntity.new(client, entopts)
  entopts = entopts or {}
...
function FileEntity:get_name()
  return self._name
end


function FileEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FileEntity.new(self._client, opts)
end
...
function FileEntity:mark_deleted()
  self._deleted = true
end


function FileEntity:deleted()
  return true == self._deleted
end


function FileEntity:data_set(args)
  if args ~= nil then
...
function FileEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FileEntity:match_set(args)
  if args ~= nil then
...
function FileEntity:stream(action, args, callopts)
...
---@param reqmatch FileLoadMatch
---@param ctrl? table
---@return File
---@return string? err
function FileEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch FileListMatch
---@param ctrl? table
---@return File[]
---@return string? err
function FileEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata FileUpdateData
---@param ctrl? table
---@return File
---@return string? err
function FileEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch FileRemoveMatch
---@param ctrl? table
---@return File
---@return string? err
function FileEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function FileEntity:_run_op(ctx, post_done)
  local utility = self._utility
