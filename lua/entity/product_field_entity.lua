...
local ProductFieldEntity = {}
ProductFieldEntity.__index = ProductFieldEntity


function ProductFieldEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProductFieldEntity)
  self._name = "product_field"
  self._client = client
...
function ProductFieldEntity:get_name()
  return self._name
end


function ProductFieldEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProductFieldEntity.new(self._client, opts)
end
...
function ProductFieldEntity:mark_deleted()
  self._deleted = true
end


function ProductFieldEntity:deleted()
  return true == self._deleted
end


function ProductFieldEntity:data_set(args)
  if args ~= nil then
...
function ProductFieldEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProductFieldEntity:match_set(args)
  if args ~= nil then
...
function ProductFieldEntity:match_get()
...
function ProductFieldEntity:stream(action, args, callopts)
...
---@param reqmatch ProductFieldLoadMatch
---@param ctrl? table
---@return ProductField
---@return string? err
function ProductFieldEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ProductFieldListMatch
---@param ctrl? table
---@return ProductField[]
---@return string? err
function ProductFieldEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ProductFieldCreateData
---@param ctrl? table
---@return ProductField
---@return string? err
function ProductFieldEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ProductFieldUpdateData
---@param ctrl? table
---@return ProductField
---@return string? err
function ProductFieldEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ProductFieldRemoveMatch
---@param ctrl? table
---@return ProductField
---@return string? err
function ProductFieldEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ProductFieldEntity:_run_op(ctx, post_done)
  local utility = self._utility
