...
local DealFieldEntity = {}
DealFieldEntity.__index = DealFieldEntity


function DealFieldEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DealFieldEntity)
  self._name = "deal_field"
  self._client = client
...
function DealFieldEntity:get_name()
  return self._name
end


function DealFieldEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DealFieldEntity.new(self._client, opts)
end
...
function DealFieldEntity:mark_deleted()
  self._deleted = true
end


function DealFieldEntity:deleted()
  return true == self._deleted
end


function DealFieldEntity:data_set(args)
  if args ~= nil then
...
function DealFieldEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DealFieldEntity:match_set(args)
  if args ~= nil then
...
function DealFieldEntity:match_get()
...
function DealFieldEntity:stream(action, args, callopts)
...
---@param reqmatch DealFieldLoadMatch
---@param ctrl? table
---@return DealField
---@return string? err
function DealFieldEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DealFieldListMatch
---@param ctrl? table
---@return DealField[]
---@return string? err
function DealFieldEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DealFieldCreateData
---@param ctrl? table
---@return DealField
---@return string? err
function DealFieldEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DealFieldUpdateData
---@param ctrl? table
---@return DealField
---@return string? err
function DealFieldEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch DealFieldRemoveMatch
---@param ctrl? table
---@return DealField
---@return string? err
function DealFieldEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function DealFieldEntity:_run_op(ctx, post_done)
  local utility = self._utility
