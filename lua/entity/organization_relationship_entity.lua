...
local OrganizationRelationshipEntity = {}
OrganizationRelationshipEntity.__index = OrganizationRelationshipEntity


function OrganizationRelationshipEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationRelationshipEntity)
  self._name = "organization_relationship"
  self._client = client
...
function OrganizationRelationshipEntity:get_name()
  return self._name
end


function OrganizationRelationshipEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationRelationshipEntity.new(self._client, opts)
end
...
function OrganizationRelationshipEntity:mark_deleted()
  self._deleted = true
end


function OrganizationRelationshipEntity:deleted()
  return true == self._deleted
end


function OrganizationRelationshipEntity:data_set(args)
  if args ~= nil then
...
function OrganizationRelationshipEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationRelationshipEntity:match_set(args)
  if args ~= nil then
...
function OrganizationRelationshipEntity:match_get()
...
function OrganizationRelationshipEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationRelationshipLoadMatch
---@param ctrl? table
---@return OrganizationRelationship
---@return string? err
function OrganizationRelationshipEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch OrganizationRelationshipListMatch
---@param ctrl? table
---@return OrganizationRelationship[]
---@return string? err
function OrganizationRelationshipEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata OrganizationRelationshipCreateData
---@param ctrl? table
---@return OrganizationRelationship
---@return string? err
function OrganizationRelationshipEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata OrganizationRelationshipUpdateData
---@param ctrl? table
---@return OrganizationRelationship
---@return string? err
function OrganizationRelationshipEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch OrganizationRelationshipRemoveMatch
---@param ctrl? table
---@return OrganizationRelationship
---@return string? err
function OrganizationRelationshipEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function OrganizationRelationshipEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationRelationshipEntity
