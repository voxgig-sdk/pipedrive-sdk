...
local OrganizationFieldEntity = {}
OrganizationFieldEntity.__index = OrganizationFieldEntity


function OrganizationFieldEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrganizationFieldEntity)
  self._name = "organization_field"
  self._client = client
...
function OrganizationFieldEntity:get_name()
  return self._name
end


function OrganizationFieldEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrganizationFieldEntity.new(self._client, opts)
end
...
function OrganizationFieldEntity:mark_deleted()
  self._deleted = true
end


function OrganizationFieldEntity:deleted()
  return true == self._deleted
end


function OrganizationFieldEntity:data_set(args)
  if args ~= nil then
...
function OrganizationFieldEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrganizationFieldEntity:match_set(args)
  if args ~= nil then
...
function OrganizationFieldEntity:match_get()
...
function OrganizationFieldEntity:stream(action, args, callopts)
...
---@param reqmatch OrganizationFieldLoadMatch
---@param ctrl? table
---@return OrganizationField
---@return string? err
function OrganizationFieldEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch OrganizationFieldListMatch
---@param ctrl? table
---@return OrganizationField[]
---@return string? err
function OrganizationFieldEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata OrganizationFieldCreateData
---@param ctrl? table
---@return OrganizationField
---@return string? err
function OrganizationFieldEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata OrganizationFieldUpdateData
---@param ctrl? table
---@return OrganizationField
---@return string? err
function OrganizationFieldEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch OrganizationFieldRemoveMatch
---@param ctrl? table
---@return OrganizationField
---@return string? err
function OrganizationFieldEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function OrganizationFieldEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OrganizationFieldEntity
