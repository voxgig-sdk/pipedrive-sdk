...
---@param reqmatch DealLoadMatch
---@param ctrl? table
---@return Deal
---@return string? err
function DealEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DealCreateData
---@param ctrl? table
---@return Deal
---@return string? err
function DealEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DealUpdateData
---@param ctrl? table
---@return Deal
---@return string? err
function DealEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch DealRemoveMatch
---@param ctrl? table
---@return Deal
---@return string? err
function DealEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
