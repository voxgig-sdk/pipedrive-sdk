...
local LeadLabelEntity = {}
LeadLabelEntity.__index = LeadLabelEntity


function LeadLabelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LeadLabelEntity)
  self._name = "lead_label"
  self._client = client
...
function LeadLabelEntity:get_name()
  return self._name
end


function LeadLabelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LeadLabelEntity.new(self._client, opts)
end
...
function LeadLabelEntity:mark_deleted()
  self._deleted = true
end


function LeadLabelEntity:deleted()
  return true == self._deleted
end


function LeadLabelEntity:data_set(args)
  if args ~= nil then
...
function LeadLabelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LeadLabelEntity:match_set(args)
  if args ~= nil then
...
function LeadLabelEntity:match_get()
...
function LeadLabelEntity:stream(action, args, callopts)
...
---@param reqmatch LeadLabelListMatch
---@param ctrl? table
---@return LeadLabel[]
---@return string? err
function LeadLabelEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata LeadLabelCreateData
---@param ctrl? table
---@return LeadLabel
---@return string? err
function LeadLabelEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata LeadLabelUpdateData
---@param ctrl? table
---@return LeadLabel
---@return string? err
function LeadLabelEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch LeadLabelRemoveMatch
---@param ctrl? table
---@return LeadLabel
---@return string? err
function LeadLabelEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function LeadLabelEntity:_run_op(ctx, post_done)
  local utility = self._utility
