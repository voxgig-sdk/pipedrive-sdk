...
local UserSettingEntity = {}
UserSettingEntity.__index = UserSettingEntity


function UserSettingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserSettingEntity)
  self._name = "user_setting"
  self._client = client
...
function UserSettingEntity:get_name()
  return self._name
end


function UserSettingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserSettingEntity.new(self._client, opts)
end
...
function UserSettingEntity:mark_deleted()
  self._deleted = true
end


function UserSettingEntity:deleted()
  return true == self._deleted
end


function UserSettingEntity:data_set(args)
  if args ~= nil then
...
function UserSettingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserSettingEntity:match_set(args)
  if args ~= nil then
...
function UserSettingEntity:match_get()
...
function UserSettingEntity:stream(action, args, callopts)
...
---@param reqmatch UserSettingLoadMatch
---@param ctrl? table
---@return UserSetting
---@return string? err
function UserSettingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UserSettingEntity:_run_op(ctx, post_done)
  local utility = self._utility
