...
---@param reqdata PersonCreateData
---@param ctrl? table
---@return Person
---@return string? err
function PersonEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PersonUpdateData
---@param ctrl? table
---@return Person
---@return string? err
function PersonEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PersonRemoveMatch
---@param ctrl? table
---@return Person
---@return string? err
function PersonEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
