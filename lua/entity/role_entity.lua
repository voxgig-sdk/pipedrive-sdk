...
local RoleEntity = {}
RoleEntity.__index = RoleEntity


function RoleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RoleEntity)
  self._name = "role"
  self._client = client
...
function RoleEntity:get_name()
  return self._name
end


function RoleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RoleEntity.new(self._client, opts)
end
...
function RoleEntity:mark_deleted()
  self._deleted = true
end


function RoleEntity:deleted()
  return true == self._deleted
end


function RoleEntity:data_set(args)
  if args ~= nil then
...
function RoleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RoleEntity:match_set(args)
  if args ~= nil then
...
function RoleEntity:stream(action, args, callopts)
...
---@param reqmatch RoleLoadMatch
---@param ctrl? table
---@return Role
---@return string? err
function RoleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RoleListMatch
---@param ctrl? table
---@return Role[]
---@return string? err
function RoleEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata RoleCreateData
---@param ctrl? table
---@return Role
---@return string? err
function RoleEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata RoleUpdateData
---@param ctrl? table
---@return Role
---@return string? err
function RoleEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch RoleRemoveMatch
---@param ctrl? table
---@return Role
---@return string? err
function RoleEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function RoleEntity:_run_op(ctx, post_done)
  local utility = self._utility
