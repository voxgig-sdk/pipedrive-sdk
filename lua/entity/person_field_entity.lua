...
local PersonFieldEntity = {}
PersonFieldEntity.__index = PersonFieldEntity


function PersonFieldEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PersonFieldEntity)
  self._name = "person_field"
  self._client = client
...
function PersonFieldEntity:get_name()
  return self._name
end


function PersonFieldEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PersonFieldEntity.new(self._client, opts)
end
...
function PersonFieldEntity:mark_deleted()
  self._deleted = true
end


function PersonFieldEntity:deleted()
  return true == self._deleted
end


function PersonFieldEntity:data_set(args)
  if args ~= nil then
...
function PersonFieldEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PersonFieldEntity:match_set(args)
  if args ~= nil then
...
function PersonFieldEntity:match_get()
...
function PersonFieldEntity:stream(action, args, callopts)
...
---@param reqmatch PersonFieldLoadMatch
---@param ctrl? table
---@return PersonField
---@return string? err
function PersonFieldEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PersonFieldListMatch
---@param ctrl? table
---@return PersonField[]
---@return string? err
function PersonFieldEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PersonFieldCreateData
---@param ctrl? table
---@return PersonField
---@return string? err
function PersonFieldEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PersonFieldUpdateData
---@param ctrl? table
---@return PersonField
---@return string? err
function PersonFieldEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PersonFieldRemoveMatch
---@param ctrl? table
---@return PersonField
---@return string? err
function PersonFieldEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function PersonFieldEntity:_run_op(ctx, post_done)
  local utility = self._utility
