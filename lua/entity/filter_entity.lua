...
---@param reqmatch FilterLoadMatch
---@param ctrl? table
---@return Filter
---@return string? err
function FilterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata FilterCreateData
---@param ctrl? table
---@return Filter
---@return string? err
function FilterEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata FilterUpdateData
---@param ctrl? table
---@return Filter
---@return string? err
function FilterEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch FilterRemoveMatch
---@param ctrl? table
---@return Filter
---@return string? err
function FilterEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
