...
local PipelineEntity = {}
PipelineEntity.__index = PipelineEntity


function PipelineEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PipelineEntity)
  self._name = "pipeline"
  self._client = client
...
function PipelineEntity:get_name()
  return self._name
end


function PipelineEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PipelineEntity.new(self._client, opts)
end
...
function PipelineEntity:mark_deleted()
  self._deleted = true
end


function PipelineEntity:deleted()
  return true == self._deleted
end


function PipelineEntity:data_set(args)
  if args ~= nil then
...
function PipelineEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PipelineEntity:match_set(args)
  if args ~= nil then
...
function PipelineEntity:match_get()
...
function PipelineEntity:stream(action, args, callopts)
...
---@param reqmatch PipelineLoadMatch
---@param ctrl? table
---@return Pipeline
---@return string? err
function PipelineEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PipelineListMatch
---@param ctrl? table
---@return Pipeline[]
---@return string? err
function PipelineEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function PipelineEntity:_run_op(ctx, post_done)
  local utility = self._utility
