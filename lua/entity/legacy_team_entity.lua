...
local LegacyTeamEntity = {}
LegacyTeamEntity.__index = LegacyTeamEntity


function LegacyTeamEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LegacyTeamEntity)
  self._name = "legacy_team"
  self._client = client
...
function LegacyTeamEntity:get_name()
  return self._name
end


function LegacyTeamEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LegacyTeamEntity.new(self._client, opts)
end
...
function LegacyTeamEntity:mark_deleted()
  self._deleted = true
end


function LegacyTeamEntity:deleted()
  return true == self._deleted
end


function LegacyTeamEntity:data_set(args)
  if args ~= nil then
...
function LegacyTeamEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LegacyTeamEntity:match_set(args)
  if args ~= nil then
...
function LegacyTeamEntity:match_get()
...
function LegacyTeamEntity:stream(action, args, callopts)
...
---@param reqmatch LegacyTeamLoadMatch
---@param ctrl? table
---@return LegacyTeam
---@return string? err
function LegacyTeamEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch LegacyTeamListMatch
---@param ctrl? table
---@return LegacyTeam[]
---@return string? err
function LegacyTeamEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata LegacyTeamCreateData
---@param ctrl? table
---@return LegacyTeam
---@return string? err
function LegacyTeamEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata LegacyTeamUpdateData
---@param ctrl? table
---@return LegacyTeam
---@return string? err
function LegacyTeamEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch LegacyTeamRemoveMatch
---@param ctrl? table
---@return LegacyTeam
---@return string? err
function LegacyTeamEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function LegacyTeamEntity:_run_op(ctx, post_done)
  local utility = self._utility
