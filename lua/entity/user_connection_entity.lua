...
local UserConnectionEntity = {}
UserConnectionEntity.__index = UserConnectionEntity


function UserConnectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UserConnectionEntity)
  self._name = "user_connection"
  self._client = client
...
function UserConnectionEntity:get_name()
  return self._name
end


function UserConnectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UserConnectionEntity.new(self._client, opts)
end
...
function UserConnectionEntity:mark_deleted()
  self._deleted = true
end


function UserConnectionEntity:deleted()
  return true == self._deleted
end


function UserConnectionEntity:data_set(args)
  if args ~= nil then
...
function UserConnectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UserConnectionEntity:match_set(args)
  if args ~= nil then
...
function UserConnectionEntity:match_get()
...
function UserConnectionEntity:stream(action, args, callopts)
...
---@param reqmatch UserConnectionLoadMatch
---@param ctrl? table
---@return UserConnection
---@return string? err
function UserConnectionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UserConnectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
