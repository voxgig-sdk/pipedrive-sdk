...
describe("RecentDirect", function()
  it("should direct-list-recent", function()
    local setup = recent_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-recent", setup.live and "live" or "unit")
