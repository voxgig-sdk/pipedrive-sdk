...
describe("UserConnectionDirect", function()
  it("should direct-load-user_connection", function()
    local setup = user_connection_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_connection", setup.live and "live" or "unit")
