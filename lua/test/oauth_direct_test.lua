...
describe("OauthDirect", function()
  it("should direct-load-oauth", function()
    local setup = oauth_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-oauth", setup.live and "live" or "unit")
