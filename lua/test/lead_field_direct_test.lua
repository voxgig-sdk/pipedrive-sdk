...
describe("LeadFieldDirect", function()
  it("should direct-list-lead_field", function()
    local setup = lead_field_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-lead_field", setup.live and "live" or "unit")
