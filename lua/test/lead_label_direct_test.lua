...
describe("LeadLabelDirect", function()
  it("should direct-list-lead_label", function()
    local setup = lead_label_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-lead_label", setup.live and "live" or "unit")
