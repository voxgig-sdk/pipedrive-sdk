...
describe("UserSettingDirect", function()
  it("should direct-load-user_setting", function()
    local setup = user_setting_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-user_setting", setup.live and "live" or "unit")
