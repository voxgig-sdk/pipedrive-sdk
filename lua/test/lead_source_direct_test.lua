...
describe("LeadSourceDirect", function()
  it("should direct-list-lead_source", function()
    local setup = lead_source_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-lead_source", setup.live and "live" or "unit")
