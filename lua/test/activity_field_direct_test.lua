...
describe("ActivityFieldDirect", function()
  it("should direct-list-activity_field", function()
    local setup = activity_field_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-activity_field", setup.live and "live" or "unit")
