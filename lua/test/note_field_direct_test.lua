...
describe("NoteFieldDirect", function()
  it("should direct-list-note_field", function()
    local setup = note_field_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-note_field", setup.live and "live" or "unit")
