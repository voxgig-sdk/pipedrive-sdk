...
describe("GoalDirect", function()
  it("should direct-load-goal", function()
    local setup = goal_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-goal", setup.live and "live" or "unit")
