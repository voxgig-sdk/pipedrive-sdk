...
describe("ActivityTypeDirect", function()
  it("should direct-list-activity_type", function()
    local setup = activity_type_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-activity_type", setup.live and "live" or "unit")
