...
func NewNoteEntity(client *core.PipedriveSDK, entopts map[string]any) *NoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NoteEntity) GetName() string { return e.name }
...
func (e *NoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NoteEntity) Deleted() bool {
	return e.deleted
}


func (e *NoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNoteEntity(e.client, opts)
}

func (e *NoteEntity) Data(args ...any) any {
...
func (e *NoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Note; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NoteEntity) DataTyped(data ...Note) Note {
	if len(data) > 0 {
		return typedFrom[Note](e.Data(asMap(data[0])))
	}
	return typedFrom[Note](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Note (all fields
// optional at the wire level).
func (e *NoteEntity) MatchTyped(match ...Note) Note {
	if len(match) > 0 {
		return typedFrom[Note](e.Match(asMap(match[0])))
	}
	return typedFrom[Note](e.Match())
}
...
func (e *NoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NoteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NoteLoadMatch and returns an Note. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NoteEntity) LoadTyped(reqmatch NoteLoadMatch, ctrl map[string]any) (Note, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Note{}, err
	}
	return typedFrom[Note](res), nil
}




func (e *NoteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// NoteListMatch and returns []Note. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *NoteEntity) ListTyped(reqmatch NoteListMatch, ctrl map[string]any) ([]Note, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Note](res), nil
}




func (e *NoteEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// NoteCreateData and returns an Note. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *NoteEntity) CreateTyped(reqdata NoteCreateData, ctrl map[string]any) (Note, error) {
...
func (e *NoteEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// NoteUpdateData and returns an Note. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *NoteEntity) UpdateTyped(reqdata NoteUpdateData, ctrl map[string]any) (Note, error) {
...
func (e *NoteEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// NoteRemoveMatch and returns an Note. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *NoteEntity) RemoveTyped(reqmatch NoteRemoveMatch, ctrl map[string]any) (Note, error) {
...
func (e *NoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
