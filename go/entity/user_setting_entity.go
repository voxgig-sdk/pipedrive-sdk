...
func NewUserSettingEntity(client *core.PipedriveSDK, entopts map[string]any) *UserSettingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserSettingEntity) GetName() string { return e.name }
...
func (e *UserSettingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserSettingEntity) Deleted() bool {
	return e.deleted
}


func (e *UserSettingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserSettingEntity(e.client, opts)
}

func (e *UserSettingEntity) Data(args ...any) any {
...
func (e *UserSettingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserSetting; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserSettingEntity) DataTyped(data ...UserSetting) UserSetting {
	if len(data) > 0 {
		return typedFrom[UserSetting](e.Data(asMap(data[0])))
	}
	return typedFrom[UserSetting](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserSetting (all fields
// optional at the wire level).
func (e *UserSettingEntity) MatchTyped(match ...UserSetting) UserSetting {
	if len(match) > 0 {
		return typedFrom[UserSetting](e.Match(asMap(match[0])))
	}
	return typedFrom[UserSetting](e.Match())
}
...
func (e *UserSettingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserSettingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserSettingLoadMatch and returns an UserSetting. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserSettingEntity) LoadTyped(reqmatch UserSettingLoadMatch, ctrl map[string]any) (UserSetting, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UserSetting{}, err
	}
	return typedFrom[UserSetting](res), nil
}



func (e *UserSettingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UserSettingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserSettingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserSettingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserSettingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
