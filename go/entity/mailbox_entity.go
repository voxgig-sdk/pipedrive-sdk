...
func NewMailboxEntity(client *core.PipedriveSDK, entopts map[string]any) *MailboxEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MailboxEntity) GetName() string { return e.name }
...
func (e *MailboxEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MailboxEntity) Deleted() bool {
	return e.deleted
}


func (e *MailboxEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMailboxEntity(e.client, opts)
}

func (e *MailboxEntity) Data(args ...any) any {
...
func (e *MailboxEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Mailbox; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MailboxEntity) DataTyped(data ...Mailbox) Mailbox {
	if len(data) > 0 {
		return typedFrom[Mailbox](e.Data(asMap(data[0])))
	}
	return typedFrom[Mailbox](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Mailbox (all fields
// optional at the wire level).
func (e *MailboxEntity) MatchTyped(match ...Mailbox) Mailbox {
	if len(match) > 0 {
		return typedFrom[Mailbox](e.Match(asMap(match[0])))
	}
	return typedFrom[Mailbox](e.Match())
}
...
func (e *MailboxEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MailboxEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MailboxLoadMatch and returns an Mailbox. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MailboxEntity) LoadTyped(reqmatch MailboxLoadMatch, ctrl map[string]any) (Mailbox, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Mailbox{}, err
	}
	return typedFrom[Mailbox](res), nil
}




func (e *MailboxEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MailboxListMatch and returns []Mailbox. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MailboxEntity) ListTyped(reqmatch MailboxListMatch, ctrl map[string]any) ([]Mailbox, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Mailbox](res), nil
}



func (e *MailboxEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *MailboxEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// MailboxUpdateData and returns an Mailbox. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *MailboxEntity) UpdateTyped(reqdata MailboxUpdateData, ctrl map[string]any) (Mailbox, error) {
...
func (e *MailboxEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// MailboxRemoveMatch and returns an Mailbox. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *MailboxEntity) RemoveTyped(reqmatch MailboxRemoveMatch, ctrl map[string]any) (Mailbox, error) {
...
func (e *MailboxEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
