...
type ProjectPhaseEntity struct {
	name    string
...
func NewProjectPhaseEntity(client *core.PipedriveSDK, entopts map[string]any) *ProjectPhaseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectPhaseEntity) GetName() string { return e.name }
...
func (e *ProjectPhaseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectPhaseEntity) Deleted() bool {
	return e.deleted
}


func (e *ProjectPhaseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectPhaseEntity(e.client, opts)
}

func (e *ProjectPhaseEntity) Data(args ...any) any {
...
func (e *ProjectPhaseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectPhase; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectPhaseEntity) DataTyped(data ...ProjectPhase) ProjectPhase {
	if len(data) > 0 {
		return typedFrom[ProjectPhase](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectPhase](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectPhase (all fields
// optional at the wire level).
func (e *ProjectPhaseEntity) MatchTyped(match ...ProjectPhase) ProjectPhase {
	if len(match) > 0 {
		return typedFrom[ProjectPhase](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectPhase](e.Match())
}
...
func (e *ProjectPhaseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectPhaseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectPhaseLoadMatch and returns an ProjectPhase. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProjectPhaseEntity) LoadTyped(reqmatch ProjectPhaseLoadMatch, ctrl map[string]any) (ProjectPhase, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ProjectPhase{}, err
	}
	return typedFrom[ProjectPhase](res), nil
}




func (e *ProjectPhaseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ProjectPhaseListMatch and returns []ProjectPhase. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProjectPhaseEntity) ListTyped(reqmatch ProjectPhaseListMatch, ctrl map[string]any) ([]ProjectPhase, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ProjectPhase](res), nil
}



func (e *ProjectPhaseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProjectPhaseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProjectPhaseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProjectPhaseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
