...
func NewNoteFieldEntity(client *core.PipedriveSDK, entopts map[string]any) *NoteFieldEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NoteFieldEntity) GetName() string { return e.name }
...
func (e *NoteFieldEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NoteFieldEntity) Deleted() bool {
	return e.deleted
}


func (e *NoteFieldEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNoteFieldEntity(e.client, opts)
}

func (e *NoteFieldEntity) Data(args ...any) any {
...
func (e *NoteFieldEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NoteField; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NoteFieldEntity) DataTyped(data ...NoteField) NoteField {
	if len(data) > 0 {
		return typedFrom[NoteField](e.Data(asMap(data[0])))
	}
	return typedFrom[NoteField](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NoteField (all fields
// optional at the wire level).
func (e *NoteFieldEntity) MatchTyped(match ...NoteField) NoteField {
	if len(match) > 0 {
		return typedFrom[NoteField](e.Match(asMap(match[0])))
	}
	return typedFrom[NoteField](e.Match())
}
...
func (e *NoteFieldEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NoteFieldEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *NoteFieldEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NoteFieldListMatch and returns []NoteField. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *NoteFieldEntity) ListTyped(reqmatch NoteFieldListMatch, ctrl map[string]any) ([]NoteField, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[NoteField](res), nil
}



func (e *NoteFieldEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NoteFieldEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NoteFieldEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NoteFieldEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
