...
func NewPipelineEntity(client *core.PipedriveSDK, entopts map[string]any) *PipelineEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PipelineEntity) GetName() string { return e.name }
...
func (e *PipelineEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PipelineEntity) Deleted() bool {
	return e.deleted
}


func (e *PipelineEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPipelineEntity(e.client, opts)
}

func (e *PipelineEntity) Data(args ...any) any {
...
func (e *PipelineEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pipeline; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PipelineEntity) DataTyped(data ...Pipeline) Pipeline {
	if len(data) > 0 {
		return typedFrom[Pipeline](e.Data(asMap(data[0])))
	}
	return typedFrom[Pipeline](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pipeline (all fields
// optional at the wire level).
func (e *PipelineEntity) MatchTyped(match ...Pipeline) Pipeline {
	if len(match) > 0 {
		return typedFrom[Pipeline](e.Match(asMap(match[0])))
	}
	return typedFrom[Pipeline](e.Match())
}
...
func (e *PipelineEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PipelineEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PipelineLoadMatch and returns an Pipeline. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PipelineEntity) LoadTyped(reqmatch PipelineLoadMatch, ctrl map[string]any) (Pipeline, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Pipeline{}, err
	}
	return typedFrom[Pipeline](res), nil
}




func (e *PipelineEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PipelineListMatch and returns []Pipeline. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PipelineEntity) ListTyped(reqmatch PipelineListMatch, ctrl map[string]any) ([]Pipeline, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Pipeline](res), nil
}



func (e *PipelineEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PipelineEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PipelineEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PipelineEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
