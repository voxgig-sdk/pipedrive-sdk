...
func NewTaskEntity(client *core.PipedriveSDK, entopts map[string]any) *TaskEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TaskEntity) GetName() string { return e.name }
...
func (e *TaskEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TaskEntity) Deleted() bool {
	return e.deleted
}


func (e *TaskEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTaskEntity(e.client, opts)
}

func (e *TaskEntity) Data(args ...any) any {
...
func (e *TaskEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Task; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TaskEntity) DataTyped(data ...Task) Task {
	if len(data) > 0 {
		return typedFrom[Task](e.Data(asMap(data[0])))
	}
	return typedFrom[Task](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Task (all fields
// optional at the wire level).
func (e *TaskEntity) MatchTyped(match ...Task) Task {
	if len(match) > 0 {
		return typedFrom[Task](e.Match(asMap(match[0])))
	}
	return typedFrom[Task](e.Match())
}
...
func (e *TaskEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TaskEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TaskLoadMatch and returns an Task. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TaskEntity) LoadTyped(reqmatch TaskLoadMatch, ctrl map[string]any) (Task, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Task{}, err
	}
	return typedFrom[Task](res), nil
}




func (e *TaskEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TaskListMatch and returns []Task. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TaskEntity) ListTyped(reqmatch TaskListMatch, ctrl map[string]any) ([]Task, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Task](res), nil
}




func (e *TaskEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TaskCreateData and returns an Task. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TaskEntity) CreateTyped(reqdata TaskCreateData, ctrl map[string]any) (Task, error) {
...
func (e *TaskEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// TaskUpdateData and returns an Task. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *TaskEntity) UpdateTyped(reqdata TaskUpdateData, ctrl map[string]any) (Task, error) {
...
func (e *TaskEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// TaskRemoveMatch and returns an Task. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *TaskEntity) RemoveTyped(reqmatch TaskRemoveMatch, ctrl map[string]any) (Task, error) {
...
func (e *TaskEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
