...
func NewLeadSourceEntity(client *core.PipedriveSDK, entopts map[string]any) *LeadSourceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LeadSourceEntity) GetName() string { return e.name }
...
func (e *LeadSourceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LeadSourceEntity) Deleted() bool {
	return e.deleted
}


func (e *LeadSourceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLeadSourceEntity(e.client, opts)
}

func (e *LeadSourceEntity) Data(args ...any) any {
...
func (e *LeadSourceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LeadSource; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LeadSourceEntity) DataTyped(data ...LeadSource) LeadSource {
	if len(data) > 0 {
		return typedFrom[LeadSource](e.Data(asMap(data[0])))
	}
	return typedFrom[LeadSource](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LeadSource (all fields
// optional at the wire level).
func (e *LeadSourceEntity) MatchTyped(match ...LeadSource) LeadSource {
	if len(match) > 0 {
		return typedFrom[LeadSource](e.Match(asMap(match[0])))
	}
	return typedFrom[LeadSource](e.Match())
}
...
func (e *LeadSourceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LeadSourceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LeadSourceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LeadSourceListMatch and returns []LeadSource. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LeadSourceEntity) ListTyped(reqmatch LeadSourceListMatch, ctrl map[string]any) ([]LeadSource, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LeadSource](res), nil
}



func (e *LeadSourceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LeadSourceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LeadSourceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LeadSourceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
