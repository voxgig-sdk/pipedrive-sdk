...
func NewPersonEntity(client *core.PipedriveSDK, entopts map[string]any) *PersonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PersonEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PersonCreateData and returns an Person. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PersonEntity) CreateTyped(reqdata PersonCreateData, ctrl map[string]any) (Person, error) {
...
func (e *PersonEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// PersonUpdateData and returns an Person. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PersonEntity) UpdateTyped(reqdata PersonUpdateData, ctrl map[string]any) (Person, error) {
...
func (e *PersonEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PersonRemoveMatch and returns an Person. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PersonEntity) RemoveTyped(reqmatch PersonRemoveMatch, ctrl map[string]any) (Person, error) {
