...
func NewCallLogEntity(client *core.PipedriveSDK, entopts map[string]any) *CallLogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CallLogEntity) GetName() string { return e.name }
...
func (e *CallLogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CallLogEntity) Deleted() bool {
	return e.deleted
}


func (e *CallLogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCallLogEntity(e.client, opts)
}

func (e *CallLogEntity) Data(args ...any) any {
...
func (e *CallLogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CallLog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CallLogEntity) DataTyped(data ...CallLog) CallLog {
	if len(data) > 0 {
		return typedFrom[CallLog](e.Data(asMap(data[0])))
	}
	return typedFrom[CallLog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CallLog (all fields
// optional at the wire level).
func (e *CallLogEntity) MatchTyped(match ...CallLog) CallLog {
	if len(match) > 0 {
		return typedFrom[CallLog](e.Match(asMap(match[0])))
	}
	return typedFrom[CallLog](e.Match())
}
...
func (e *CallLogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CallLogEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CallLogLoadMatch and returns an CallLog. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CallLogEntity) LoadTyped(reqmatch CallLogLoadMatch, ctrl map[string]any) (CallLog, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return CallLog{}, err
	}
	return typedFrom[CallLog](res), nil
}




func (e *CallLogEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CallLogListMatch and returns []CallLog. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CallLogEntity) ListTyped(reqmatch CallLogListMatch, ctrl map[string]any) ([]CallLog, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CallLog](res), nil
}




func (e *CallLogEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CallLogCreateData and returns an CallLog. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CallLogEntity) CreateTyped(reqdata CallLogCreateData, ctrl map[string]any) (CallLog, error) {
...
func (e *CallLogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *CallLogEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CallLogRemoveMatch and returns an CallLog. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CallLogEntity) RemoveTyped(reqmatch CallLogRemoveMatch, ctrl map[string]any) (CallLog, error) {
...
func (e *CallLogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
