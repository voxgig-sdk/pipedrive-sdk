...
type ActivityFieldEntity struct {
	name    string
...
func NewActivityFieldEntity(client *core.PipedriveSDK, entopts map[string]any) *ActivityFieldEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActivityFieldEntity) GetName() string { return e.name }
...
func (e *ActivityFieldEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActivityFieldEntity) Deleted() bool {
	return e.deleted
}


func (e *ActivityFieldEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActivityFieldEntity(e.client, opts)
}

func (e *ActivityFieldEntity) Data(args ...any) any {
...
func (e *ActivityFieldEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ActivityField; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActivityFieldEntity) DataTyped(data ...ActivityField) ActivityField {
	if len(data) > 0 {
		return typedFrom[ActivityField](e.Data(asMap(data[0])))
	}
	return typedFrom[ActivityField](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ActivityField (all fields
// optional at the wire level).
func (e *ActivityFieldEntity) MatchTyped(match ...ActivityField) ActivityField {
	if len(match) > 0 {
		return typedFrom[ActivityField](e.Match(asMap(match[0])))
	}
	return typedFrom[ActivityField](e.Match())
}
...
func (e *ActivityFieldEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActivityFieldEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ActivityFieldEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActivityFieldListMatch and returns []ActivityField. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ActivityFieldEntity) ListTyped(reqmatch ActivityFieldListMatch, ctrl map[string]any) ([]ActivityField, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ActivityField](res), nil
}



func (e *ActivityFieldEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ActivityFieldEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActivityFieldEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ActivityFieldEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
