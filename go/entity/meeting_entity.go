...
func NewMeetingEntity(client *core.PipedriveSDK, entopts map[string]any) *MeetingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MeetingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MeetingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MeetingCreateData and returns an Meeting. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MeetingEntity) CreateTyped(reqdata MeetingCreateData, ctrl map[string]any) (Meeting, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Meeting{}, err
	}
	return typedFrom[Meeting](res), nil
}
...
func (e *MeetingEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// MeetingRemoveMatch and returns an Meeting. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *MeetingEntity) RemoveTyped(reqmatch MeetingRemoveMatch, ctrl map[string]any) (Meeting, error) {
