...
type ProjectBoardEntity struct {
	name    string
...
func NewProjectBoardEntity(client *core.PipedriveSDK, entopts map[string]any) *ProjectBoardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectBoardEntity) GetName() string { return e.name }
...
func (e *ProjectBoardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectBoardEntity) Deleted() bool {
	return e.deleted
}


func (e *ProjectBoardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectBoardEntity(e.client, opts)
}

func (e *ProjectBoardEntity) Data(args ...any) any {
...
func (e *ProjectBoardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectBoard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectBoardEntity) DataTyped(data ...ProjectBoard) ProjectBoard {
	if len(data) > 0 {
		return typedFrom[ProjectBoard](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectBoard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectBoard (all fields
// optional at the wire level).
func (e *ProjectBoardEntity) MatchTyped(match ...ProjectBoard) ProjectBoard {
	if len(match) > 0 {
		return typedFrom[ProjectBoard](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectBoard](e.Match())
}
...
func (e *ProjectBoardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectBoardEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectBoardLoadMatch and returns an ProjectBoard. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProjectBoardEntity) LoadTyped(reqmatch ProjectBoardLoadMatch, ctrl map[string]any) (ProjectBoard, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ProjectBoard{}, err
	}
	return typedFrom[ProjectBoard](res), nil
}




func (e *ProjectBoardEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ProjectBoardListMatch and returns []ProjectBoard. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProjectBoardEntity) ListTyped(reqmatch ProjectBoardListMatch, ctrl map[string]any) ([]ProjectBoard, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ProjectBoard](res), nil
}



func (e *ProjectBoardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProjectBoardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProjectBoardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProjectBoardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
