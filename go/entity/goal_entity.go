...
func NewGoalEntity(client *core.PipedriveSDK, entopts map[string]any) *GoalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GoalEntity) GetName() string { return e.name }
...
func (e *GoalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GoalEntity) Deleted() bool {
	return e.deleted
}


func (e *GoalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGoalEntity(e.client, opts)
}

func (e *GoalEntity) Data(args ...any) any {
...
func (e *GoalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Goal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GoalEntity) DataTyped(data ...Goal) Goal {
	if len(data) > 0 {
		return typedFrom[Goal](e.Data(asMap(data[0])))
	}
	return typedFrom[Goal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Goal (all fields
// optional at the wire level).
func (e *GoalEntity) MatchTyped(match ...Goal) Goal {
	if len(match) > 0 {
		return typedFrom[Goal](e.Match(asMap(match[0])))
	}
	return typedFrom[Goal](e.Match())
}
...
func (e *GoalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GoalEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GoalLoadMatch and returns an Goal. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GoalEntity) LoadTyped(reqmatch GoalLoadMatch, ctrl map[string]any) (Goal, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Goal{}, err
	}
	return typedFrom[Goal](res), nil
}



func (e *GoalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GoalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GoalCreateData and returns an Goal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GoalEntity) CreateTyped(reqdata GoalCreateData, ctrl map[string]any) (Goal, error) {
...
func (e *GoalEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// GoalUpdateData and returns an Goal. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *GoalEntity) UpdateTyped(reqdata GoalUpdateData, ctrl map[string]any) (Goal, error) {
...
func (e *GoalEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// GoalRemoveMatch and returns an Goal. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *GoalEntity) RemoveTyped(reqmatch GoalRemoveMatch, ctrl map[string]any) (Goal, error) {
...
func (e *GoalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
