...
func NewOauthEntity(client *core.PipedriveSDK, entopts map[string]any) *OauthEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OauthEntity) GetName() string { return e.name }
...
func (e *OauthEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OauthEntity) Deleted() bool {
	return e.deleted
}


func (e *OauthEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOauthEntity(e.client, opts)
}

func (e *OauthEntity) Data(args ...any) any {
...
func (e *OauthEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *OauthEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OauthEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *OauthEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *OauthEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OauthEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OauthEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
