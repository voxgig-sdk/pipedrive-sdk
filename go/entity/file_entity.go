...
func NewFileEntity(client *core.PipedriveSDK, entopts map[string]any) *FileEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FileEntity) GetName() string { return e.name }
...
func (e *FileEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FileEntity) Deleted() bool {
	return e.deleted
}


func (e *FileEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFileEntity(e.client, opts)
}

func (e *FileEntity) Data(args ...any) any {
...
func (e *FileEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an File; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FileEntity) DataTyped(data ...File) File {
	if len(data) > 0 {
		return typedFrom[File](e.Data(asMap(data[0])))
	}
	return typedFrom[File](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through File (all fields
// optional at the wire level).
func (e *FileEntity) MatchTyped(match ...File) File {
	if len(match) > 0 {
		return typedFrom[File](e.Match(asMap(match[0])))
	}
	return typedFrom[File](e.Match())
}
...
func (e *FileEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FileEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FileLoadMatch and returns an File. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FileEntity) LoadTyped(reqmatch FileLoadMatch, ctrl map[string]any) (File, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return File{}, err
	}
	return typedFrom[File](res), nil
}




func (e *FileEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FileListMatch and returns []File. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FileEntity) ListTyped(reqmatch FileListMatch, ctrl map[string]any) ([]File, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[File](res), nil
}




func (e *FileEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// FileCreateData and returns an File. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FileEntity) CreateTyped(reqdata FileCreateData, ctrl map[string]any) (File, error) {
...
func (e *FileEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// FileUpdateData and returns an File. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *FileEntity) UpdateTyped(reqdata FileUpdateData, ctrl map[string]any) (File, error) {
...
func (e *FileEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// FileRemoveMatch and returns an File. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FileEntity) RemoveTyped(reqmatch FileRemoveMatch, ctrl map[string]any) (File, error) {
...
func (e *FileEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
