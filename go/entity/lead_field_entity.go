...
func NewLeadFieldEntity(client *core.PipedriveSDK, entopts map[string]any) *LeadFieldEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LeadFieldEntity) GetName() string { return e.name }
...
func (e *LeadFieldEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LeadFieldEntity) Deleted() bool {
	return e.deleted
}


func (e *LeadFieldEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLeadFieldEntity(e.client, opts)
}

func (e *LeadFieldEntity) Data(args ...any) any {
...
func (e *LeadFieldEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LeadField; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LeadFieldEntity) DataTyped(data ...LeadField) LeadField {
	if len(data) > 0 {
		return typedFrom[LeadField](e.Data(asMap(data[0])))
	}
	return typedFrom[LeadField](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LeadField (all fields
// optional at the wire level).
func (e *LeadFieldEntity) MatchTyped(match ...LeadField) LeadField {
	if len(match) > 0 {
		return typedFrom[LeadField](e.Match(asMap(match[0])))
	}
	return typedFrom[LeadField](e.Match())
}
...
func (e *LeadFieldEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LeadFieldEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LeadFieldEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LeadFieldListMatch and returns []LeadField. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LeadFieldEntity) ListTyped(reqmatch LeadFieldListMatch, ctrl map[string]any) ([]LeadField, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LeadField](res), nil
}



func (e *LeadFieldEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LeadFieldEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LeadFieldEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LeadFieldEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
