...
func NewOrganizationEntity(client *core.PipedriveSDK, entopts map[string]any) *OrganizationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrganizationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
