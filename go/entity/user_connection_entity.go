...
type UserConnectionEntity struct {
	name    string
...
func NewUserConnectionEntity(client *core.PipedriveSDK, entopts map[string]any) *UserConnectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserConnectionEntity) GetName() string { return e.name }
...
func (e *UserConnectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserConnectionEntity) Deleted() bool {
	return e.deleted
}


func (e *UserConnectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserConnectionEntity(e.client, opts)
}

func (e *UserConnectionEntity) Data(args ...any) any {
...
func (e *UserConnectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserConnection; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserConnectionEntity) DataTyped(data ...UserConnection) UserConnection {
	if len(data) > 0 {
		return typedFrom[UserConnection](e.Data(asMap(data[0])))
	}
	return typedFrom[UserConnection](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserConnection (all fields
// optional at the wire level).
func (e *UserConnectionEntity) MatchTyped(match ...UserConnection) UserConnection {
	if len(match) > 0 {
		return typedFrom[UserConnection](e.Match(asMap(match[0])))
	}
	return typedFrom[UserConnection](e.Match())
}
...
func (e *UserConnectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserConnectionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserConnectionLoadMatch and returns an UserConnection. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UserConnectionEntity) LoadTyped(reqmatch UserConnectionLoadMatch, ctrl map[string]any) (UserConnection, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UserConnection{}, err
	}
	return typedFrom[UserConnection](res), nil
}



func (e *UserConnectionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UserConnectionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UserConnectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserConnectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserConnectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
