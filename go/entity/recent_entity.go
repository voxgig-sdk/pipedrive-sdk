...
func NewRecentEntity(client *core.PipedriveSDK, entopts map[string]any) *RecentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RecentEntity) GetName() string { return e.name }
...
func (e *RecentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RecentEntity) Deleted() bool {
	return e.deleted
}


func (e *RecentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRecentEntity(e.client, opts)
}

func (e *RecentEntity) Data(args ...any) any {
...
func (e *RecentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Recent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RecentEntity) DataTyped(data ...Recent) Recent {
	if len(data) > 0 {
		return typedFrom[Recent](e.Data(asMap(data[0])))
	}
	return typedFrom[Recent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Recent (all fields
// optional at the wire level).
func (e *RecentEntity) MatchTyped(match ...Recent) Recent {
	if len(match) > 0 {
		return typedFrom[Recent](e.Match(asMap(match[0])))
	}
	return typedFrom[Recent](e.Match())
}
...
func (e *RecentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RecentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RecentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RecentListMatch and returns []Recent. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RecentEntity) ListTyped(reqmatch RecentListMatch, ctrl map[string]any) ([]Recent, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Recent](res), nil
}



func (e *RecentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RecentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RecentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RecentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
