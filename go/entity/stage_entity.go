...
func NewStageEntity(client *core.PipedriveSDK, entopts map[string]any) *StageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StageEntity) GetName() string { return e.name }
...
func (e *StageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StageEntity) Deleted() bool {
	return e.deleted
}


func (e *StageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStageEntity(e.client, opts)
}

func (e *StageEntity) Data(args ...any) any {
...
func (e *StageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Stage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StageEntity) DataTyped(data ...Stage) Stage {
	if len(data) > 0 {
		return typedFrom[Stage](e.Data(asMap(data[0])))
	}
	return typedFrom[Stage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Stage (all fields
// optional at the wire level).
func (e *StageEntity) MatchTyped(match ...Stage) Stage {
	if len(match) > 0 {
		return typedFrom[Stage](e.Match(asMap(match[0])))
	}
	return typedFrom[Stage](e.Match())
}
...
func (e *StageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StageListMatch and returns []Stage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StageEntity) ListTyped(reqmatch StageListMatch, ctrl map[string]any) ([]Stage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Stage](res), nil
}



func (e *StageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
