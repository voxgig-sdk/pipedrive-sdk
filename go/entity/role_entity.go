...
func NewRoleEntity(client *core.PipedriveSDK, entopts map[string]any) *RoleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RoleEntity) GetName() string { return e.name }
...
func (e *RoleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RoleEntity) Deleted() bool {
	return e.deleted
}


func (e *RoleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRoleEntity(e.client, opts)
}

func (e *RoleEntity) Data(args ...any) any {
...
func (e *RoleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Role; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RoleEntity) DataTyped(data ...Role) Role {
	if len(data) > 0 {
		return typedFrom[Role](e.Data(asMap(data[0])))
	}
	return typedFrom[Role](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Role (all fields
// optional at the wire level).
func (e *RoleEntity) MatchTyped(match ...Role) Role {
	if len(match) > 0 {
		return typedFrom[Role](e.Match(asMap(match[0])))
	}
	return typedFrom[Role](e.Match())
}
...
func (e *RoleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RoleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RoleLoadMatch and returns an Role. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RoleEntity) LoadTyped(reqmatch RoleLoadMatch, ctrl map[string]any) (Role, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Role{}, err
	}
	return typedFrom[Role](res), nil
}




func (e *RoleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RoleListMatch and returns []Role. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RoleEntity) ListTyped(reqmatch RoleListMatch, ctrl map[string]any) ([]Role, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Role](res), nil
}




func (e *RoleEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// RoleCreateData and returns an Role. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RoleEntity) CreateTyped(reqdata RoleCreateData, ctrl map[string]any) (Role, error) {
...
func (e *RoleEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// RoleUpdateData and returns an Role. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *RoleEntity) UpdateTyped(reqdata RoleUpdateData, ctrl map[string]any) (Role, error) {
...
func (e *RoleEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// RoleRemoveMatch and returns an Role. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *RoleEntity) RemoveTyped(reqmatch RoleRemoveMatch, ctrl map[string]any) (Role, error) {
...
func (e *RoleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
