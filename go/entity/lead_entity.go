...
func NewLeadEntity(client *core.PipedriveSDK, entopts map[string]any) *LeadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LeadEntity) GetName() string { return e.name }
...
func (e *LeadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LeadEntity) Deleted() bool {
	return e.deleted
}


func (e *LeadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLeadEntity(e.client, opts)
}

func (e *LeadEntity) Data(args ...any) any {
...
func (e *LeadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Lead; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LeadEntity) DataTyped(data ...Lead) Lead {
	if len(data) > 0 {
		return typedFrom[Lead](e.Data(asMap(data[0])))
	}
	return typedFrom[Lead](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Lead (all fields
// optional at the wire level).
func (e *LeadEntity) MatchTyped(match ...Lead) Lead {
	if len(match) > 0 {
		return typedFrom[Lead](e.Match(asMap(match[0])))
	}
	return typedFrom[Lead](e.Match())
}
...
func (e *LeadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LeadEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LeadLoadMatch and returns an Lead. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LeadEntity) LoadTyped(reqmatch LeadLoadMatch, ctrl map[string]any) (Lead, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Lead{}, err
	}
	return typedFrom[Lead](res), nil
}




func (e *LeadEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LeadListMatch and returns []Lead. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LeadEntity) ListTyped(reqmatch LeadListMatch, ctrl map[string]any) ([]Lead, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Lead](res), nil
}




func (e *LeadEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// LeadCreateData and returns an Lead. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LeadEntity) CreateTyped(reqdata LeadCreateData, ctrl map[string]any) (Lead, error) {
...
func (e *LeadEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// LeadUpdateData and returns an Lead. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *LeadEntity) UpdateTyped(reqdata LeadUpdateData, ctrl map[string]any) (Lead, error) {
...
func (e *LeadEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// LeadRemoveMatch and returns an Lead. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *LeadEntity) RemoveTyped(reqmatch LeadRemoveMatch, ctrl map[string]any) (Lead, error) {
...
func (e *LeadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
