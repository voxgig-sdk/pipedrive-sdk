...
func NewBillingEntity(client *core.PipedriveSDK, entopts map[string]any) *BillingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BillingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
