...
func NewProductEntity(client *core.PipedriveSDK, entopts map[string]any) *ProductEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProductEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *ProductEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ProductRemoveMatch and returns an Product. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ProductEntity) RemoveTyped(reqmatch ProductRemoveMatch, ctrl map[string]any) (Product, error) {
