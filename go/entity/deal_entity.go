...
func NewDealEntity(client *core.PipedriveSDK, entopts map[string]any) *DealEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DealEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DealLoadMatch and returns an Deal. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DealEntity) LoadTyped(reqmatch DealLoadMatch, ctrl map[string]any) (Deal, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Deal{}, err
	}
	return typedFrom[Deal](res), nil
}
...
func (e *DealEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DealCreateData and returns an Deal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DealEntity) CreateTyped(reqdata DealCreateData, ctrl map[string]any) (Deal, error) {
...
func (e *DealEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// DealUpdateData and returns an Deal. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *DealEntity) UpdateTyped(reqdata DealUpdateData, ctrl map[string]any) (Deal, error) {
...
func (e *DealEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// DealRemoveMatch and returns an Deal. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DealEntity) RemoveTyped(reqmatch DealRemoveMatch, ctrl map[string]any) (Deal, error) {
