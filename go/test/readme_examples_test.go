...
const testSeed = `map[string]any{"entity": map[string]any{"activity_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "activity_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "billing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "call_log": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deal_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "file": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "filter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "goal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lead": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lead_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lead_label": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lead_source": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legacy_team": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mailbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "meeting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "note": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "note_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "oauth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization_relationship": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "permission_set": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "person": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "person_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pipeline": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "product_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project_board": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project_phase": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "recent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "role": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "stage": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "task": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_connection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_setting": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
