...
class PipedriveGraphql
{
    ...
    // equivalent.
    public static function body(PipedriveContext $ctx): mixed
    {
    ...
    public static function errors(PipedriveContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
