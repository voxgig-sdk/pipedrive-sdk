...
// Pipedrive SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PipedriveTransformResponse
{
    public static function call(PipedriveContext $ctx): mixed
    {
        ...
        $transform = PipedriveHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
