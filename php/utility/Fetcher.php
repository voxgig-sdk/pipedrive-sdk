...
// Pipedrive SDK utility: fetcher

class PipedriveFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PipedriveSDK/1.0)';
    ...
    public static function call(PipedriveContext $ctx, string $fullurl, array $fetchdef): array
    {
