...
// Pipedrive SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PipedriveMakeRequest
{
    public static function call(PipedriveContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PipedriveResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PipedriveResponse($fetched);
        } else {
