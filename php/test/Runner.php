...
class PipedriveTestRunner
{
    ...
    {
        $live = self::getenv('PIPEDRIVE_TEST_LIVE');
        $override = self::getenv('PIPEDRIVE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PIPEDRIVE_TEST_EXPLAIN');
...
class_alias('PipedriveTestRunner', 'Runner');
class_alias('PipedriveHelpers', 'Helpers');
