...
class MeetingEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PIPEDRIVE_TEST_MEETING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function meeting_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PIPEDRIVE_TEST_MEETING_ENTID");
