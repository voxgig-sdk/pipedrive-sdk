...
// Pipedrive SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PipedriveSDK::test)
...
{
    private const SDK_CLASS = 'PipedriveSDK';
    ...
    private const SDK_BASE = 'pipedrive_sdk';
