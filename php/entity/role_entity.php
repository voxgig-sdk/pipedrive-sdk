...
class RoleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RoleEntity($this->_client, $opts);
    }

    /**
     * @param Role|array $args Role data (assoc-array) to store.
     */
    ...
    /**
     * @return Role|array The current Role data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Role fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Role fields).
     */
     ...
     * Load a single Role.
     *
     * @param RoleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RoleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Role|array The loaded Role as an assoc-array at the
    ...
    /**
     * List Role items matching the given filter.
     *
     * @param RoleListMatch|array|null $reqmatch Match filter (any subset
     *   of Role fields) as an assoc-array; RoleListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Role[]|array A list of Role items as assoc-arrays at
     ...
     * Create a new Role.
     *
     * @param RoleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RoleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Role|array The created Role as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param RoleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RoleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Role|array The updated Role as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Role matching the given criteria.
     *
     * @param RoleRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; RoleRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Role|array The removed Role as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
