...
class PipelineEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PipelineEntity($this->_client, $opts);
    }

    /**
     * @param Pipeline|array $args Pipeline data (assoc-array) to store.
     */
    ...
    /**
     * @return Pipeline|array The current Pipeline data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pipeline fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pipeline fields).
     */
     ...
     *
     * @param PipelineLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PipelineLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pipeline|array The loaded Pipeline as an assoc-array at the
    ...
    /**
     * List Pipeline items matching the given filter.
     *
     * @param PipelineListMatch|array|null $reqmatch Match filter (any subset
     *   of Pipeline fields) as an assoc-array; PipelineListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pipeline[]|array A list of Pipeline items as assoc-arrays at
