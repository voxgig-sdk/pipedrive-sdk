...
// Pipedrive SDK PersonField entity
...
class PersonFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PersonFieldEntity($this->_client, $opts);
    }

    /**
     * @param PersonField|array $args PersonField data (assoc-array) to store.
     */
    ...
    /**
     * @return PersonField|array The current PersonField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PersonField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PersonField fields).
     */
    ...
    /**
     * Load a single PersonField.
     *
     * @param PersonFieldLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PersonFieldLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PersonField|array The loaded PersonField as an assoc-array at the
    ...
    /**
     * List PersonField items matching the given filter.
     *
     * @param PersonFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of PersonField fields) as an assoc-array; PersonFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PersonField[]|array A list of PersonField items as assoc-arrays at
    ...
    /**
     * Create a new PersonField.
     *
     * @param PersonFieldCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PersonFieldCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PersonField|array The created PersonField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing PersonField.
     *
     * @param PersonFieldUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PersonFieldUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PersonField|array The updated PersonField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an PersonField matching the given criteria.
     *
     * @param PersonFieldRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PersonFieldRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PersonField|array The removed PersonField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
