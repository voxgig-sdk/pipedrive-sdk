...
class StageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StageEntity($this->_client, $opts);
    }

    /**
     * @param Stage|array $args Stage data (assoc-array) to store.
     */
    ...
    /**
     * @return Stage|array The current Stage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Stage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Stage fields).
     */
    ...
    /**
     * List Stage items matching the given filter.
     *
     * @param StageListMatch|array|null $reqmatch Match filter (any subset
     *   of Stage fields) as an assoc-array; StageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Stage[]|array A list of Stage items as assoc-arrays at
