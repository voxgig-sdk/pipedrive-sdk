...
class DealEntity
{
     ...
     * Load a single Deal.
     *
     * @param DealLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DealLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deal|array The loaded Deal as an assoc-array at the
     ...
     * Create a new Deal.
     *
     * @param DealCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DealCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deal|array The created Deal as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param DealUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DealUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deal|array The updated Deal as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Deal matching the given criteria.
     *
     * @param DealRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DealRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deal|array The removed Deal as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
