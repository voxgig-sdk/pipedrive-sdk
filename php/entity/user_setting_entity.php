...
// Pipedrive SDK UserSetting entity
...
class UserSettingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserSettingEntity($this->_client, $opts);
    }

    /**
     * @param UserSetting|array $args UserSetting data (assoc-array) to store.
     */
    ...
    /**
     * @return UserSetting|array The current UserSetting data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserSetting fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserSetting fields).
     */
    ...
    /**
     * Load a single UserSetting.
     *
     * @param UserSettingLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UserSettingLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserSetting|array The loaded UserSetting as an assoc-array at the
