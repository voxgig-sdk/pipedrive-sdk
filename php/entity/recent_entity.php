...
class RecentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RecentEntity($this->_client, $opts);
    }

    /**
     * @param Recent|array $args Recent data (assoc-array) to store.
     */
    ...
    /**
     * @return Recent|array The current Recent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Recent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Recent fields).
     */
    ...
    /**
     * List Recent items matching the given filter.
     *
     * @param RecentListMatch|array|null $reqmatch Match filter (any subset
     *   of Recent fields) as an assoc-array; RecentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Recent[]|array A list of Recent items as assoc-arrays at
