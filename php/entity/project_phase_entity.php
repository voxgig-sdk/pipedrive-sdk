...
// Pipedrive SDK ProjectPhase entity
...
class ProjectPhaseEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectPhaseEntity($this->_client, $opts);
    }

    /**
     * @param ProjectPhase|array $args ProjectPhase data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectPhase|array The current ProjectPhase data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectPhase fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectPhase fields).
     */
    ...
    /**
     * Load a single ProjectPhase.
     *
     * @param ProjectPhaseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectPhaseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectPhase|array The loaded ProjectPhase as an assoc-array at the
    ...
    /**
     * List ProjectPhase items matching the given filter.
     *
     * @param ProjectPhaseListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectPhase fields) as an assoc-array; ProjectPhaseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectPhase[]|array A list of ProjectPhase items as assoc-arrays at
