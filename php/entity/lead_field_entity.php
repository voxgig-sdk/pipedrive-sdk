...
// Pipedrive SDK LeadField entity
...
class LeadFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LeadFieldEntity($this->_client, $opts);
    }

    /**
     * @param LeadField|array $args LeadField data (assoc-array) to store.
     */
    ...
    /**
     * @return LeadField|array The current LeadField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LeadField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LeadField fields).
     */
    ...
    /**
     * List LeadField items matching the given filter.
     *
     * @param LeadFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of LeadField fields) as an assoc-array; LeadFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LeadField[]|array A list of LeadField items as assoc-arrays at
