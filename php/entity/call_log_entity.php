...
class CallLogEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CallLogEntity($this->_client, $opts);
    }

    /**
     * @param CallLog|array $args CallLog data (assoc-array) to store.
     */
    ...
    /**
     * @return CallLog|array The current CallLog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CallLog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CallLog fields).
     */
    ...
    /**
     * Load a single CallLog.
     *
     * @param CallLogLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CallLogLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CallLog|array The loaded CallLog as an assoc-array at the
    ...
    /**
     * List CallLog items matching the given filter.
     *
     * @param CallLogListMatch|array|null $reqmatch Match filter (any subset
     *   of CallLog fields) as an assoc-array; CallLogListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CallLog[]|array A list of CallLog items as assoc-arrays at
     ...
     *
     * @param CallLogCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CallLogCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CallLog|array The created CallLog as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an CallLog matching the given criteria.
     *
     * @param CallLogRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CallLogRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CallLog|array The removed CallLog as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
