...
class FileEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FileEntity($this->_client, $opts);
    }

    /**
     * @param File|array $args File data (assoc-array) to store.
     */
    ...
    /**
     * @return File|array The current File data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of File fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of File fields).
     */
     ...
     * Load a single File.
     *
     * @param FileLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FileLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return File|array The loaded File as an assoc-array at the
    ...
    /**
     * List File items matching the given filter.
     *
     * @param FileListMatch|array|null $reqmatch Match filter (any subset
     *   of File fields) as an assoc-array; FileListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return File[]|array A list of File items as assoc-arrays at
     ...
     * Create a new File.
     *
     * @param FileCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FileCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return File|array The created File as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param FileUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FileUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return File|array The updated File as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an File matching the given criteria.
     *
     * @param FileRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FileRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return File|array The removed File as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
