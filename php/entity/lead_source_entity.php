...
// Pipedrive SDK LeadSource entity
...
class LeadSourceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LeadSourceEntity($this->_client, $opts);
    }

    /**
     * @param LeadSource|array $args LeadSource data (assoc-array) to store.
     */
    ...
    /**
     * @return LeadSource|array The current LeadSource data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LeadSource fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LeadSource fields).
     */
    ...
    /**
     * List LeadSource items matching the given filter.
     *
     * @param LeadSourceListMatch|array|null $reqmatch Match filter (any subset
     *   of LeadSource fields) as an assoc-array; LeadSourceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LeadSource[]|array A list of LeadSource items as assoc-arrays at
