...
class MailboxEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MailboxEntity($this->_client, $opts);
    }

    /**
     * @param Mailbox|array $args Mailbox data (assoc-array) to store.
     */
    ...
    /**
     * @return Mailbox|array The current Mailbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Mailbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Mailbox fields).
     */
    ...
    /**
     * Load a single Mailbox.
     *
     * @param MailboxLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MailboxLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mailbox|array The loaded Mailbox as an assoc-array at the
    ...
    /**
     * List Mailbox items matching the given filter.
     *
     * @param MailboxListMatch|array|null $reqmatch Match filter (any subset
     *   of Mailbox fields) as an assoc-array; MailboxListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mailbox[]|array A list of Mailbox items as assoc-arrays at
     ...
     *
     * @param MailboxUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MailboxUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mailbox|array The updated Mailbox as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Mailbox matching the given criteria.
     *
     * @param MailboxRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MailboxRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Mailbox|array The removed Mailbox as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
