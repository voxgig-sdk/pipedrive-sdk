...
// Pipedrive SDK DealField entity
...
class DealFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DealFieldEntity($this->_client, $opts);
    }

    /**
     * @param DealField|array $args DealField data (assoc-array) to store.
     */
    ...
    /**
     * @return DealField|array The current DealField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DealField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DealField fields).
     */
    ...
    /**
     * Load a single DealField.
     *
     * @param DealFieldLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DealFieldLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DealField|array The loaded DealField as an assoc-array at the
    ...
    /**
     * List DealField items matching the given filter.
     *
     * @param DealFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of DealField fields) as an assoc-array; DealFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DealField[]|array A list of DealField items as assoc-arrays at
    ...
    /**
     * Create a new DealField.
     *
     * @param DealFieldCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DealFieldCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DealField|array The created DealField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing DealField.
     *
     * @param DealFieldUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DealFieldUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DealField|array The updated DealField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an DealField matching the given criteria.
     *
     * @param DealFieldRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DealFieldRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DealField|array The removed DealField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
