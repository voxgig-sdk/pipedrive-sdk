...
// Pipedrive SDK PermissionSet entity
...
class PermissionSetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PermissionSetEntity($this->_client, $opts);
    }

    /**
     * @param PermissionSet|array $args PermissionSet data (assoc-array) to store.
     */
    ...
    /**
     * @return PermissionSet|array The current PermissionSet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PermissionSet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PermissionSet fields).
     */
    ...
    /**
     * Load a single PermissionSet.
     *
     * @param PermissionSetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PermissionSetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PermissionSet|array The loaded PermissionSet as an assoc-array at the
    ...
    /**
     * List PermissionSet items matching the given filter.
     *
     * @param PermissionSetListMatch|array|null $reqmatch Match filter (any subset
     *   of PermissionSet fields) as an assoc-array; PermissionSetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PermissionSet[]|array A list of PermissionSet items as assoc-arrays at
