...
// Pipedrive SDK ActivityField entity
...
class ActivityFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActivityFieldEntity($this->_client, $opts);
    }

    /**
     * @param ActivityField|array $args ActivityField data (assoc-array) to store.
     */
    ...
    /**
     * @return ActivityField|array The current ActivityField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActivityField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActivityField fields).
     */
    ...
    /**
     * List ActivityField items matching the given filter.
     *
     * @param ActivityFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of ActivityField fields) as an assoc-array; ActivityFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityField[]|array A list of ActivityField items as assoc-arrays at
