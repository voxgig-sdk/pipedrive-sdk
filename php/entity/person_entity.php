...
class PersonEntity
{
     ...
     * Create a new Person.
     *
     * @param PersonCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PersonCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Person|array The created Person as an assoc-array at the
     ...
     *
     * @param PersonUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PersonUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Person|array The updated Person as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Person matching the given criteria.
     *
     * @param PersonRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PersonRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Person|array The removed Person as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
