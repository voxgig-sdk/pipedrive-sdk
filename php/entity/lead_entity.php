...
class LeadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LeadEntity($this->_client, $opts);
    }

    /**
     * @param Lead|array $args Lead data (assoc-array) to store.
     */
    ...
    /**
     * @return Lead|array The current Lead data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Lead fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Lead fields).
     */
     ...
     * Load a single Lead.
     *
     * @param LeadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LeadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lead|array The loaded Lead as an assoc-array at the
    ...
    /**
     * List Lead items matching the given filter.
     *
     * @param LeadListMatch|array|null $reqmatch Match filter (any subset
     *   of Lead fields) as an assoc-array; LeadListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lead[]|array A list of Lead items as assoc-arrays at
     ...
     * Create a new Lead.
     *
     * @param LeadCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LeadCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lead|array The created Lead as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param LeadUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LeadUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lead|array The updated Lead as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Lead matching the given criteria.
     *
     * @param LeadRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; LeadRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Lead|array The removed Lead as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
