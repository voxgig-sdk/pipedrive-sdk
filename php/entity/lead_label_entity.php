...
// Pipedrive SDK LeadLabel entity
...
class LeadLabelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LeadLabelEntity($this->_client, $opts);
    }

    /**
     * @param LeadLabel|array $args LeadLabel data (assoc-array) to store.
     */
    ...
    /**
     * @return LeadLabel|array The current LeadLabel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LeadLabel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LeadLabel fields).
     */
    ...
    /**
     * List LeadLabel items matching the given filter.
     *
     * @param LeadLabelListMatch|array|null $reqmatch Match filter (any subset
     *   of LeadLabel fields) as an assoc-array; LeadLabelListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LeadLabel[]|array A list of LeadLabel items as assoc-arrays at
    ...
    /**
     * Create a new LeadLabel.
     *
     * @param LeadLabelCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LeadLabelCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LeadLabel|array The created LeadLabel as an assoc-array at the
    ...
    /**
     * Update an existing LeadLabel.
     *
     * @param LeadLabelUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LeadLabelUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LeadLabel|array The updated LeadLabel as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an LeadLabel matching the given criteria.
     *
     * @param LeadLabelRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; LeadLabelRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LeadLabel|array The removed LeadLabel as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
