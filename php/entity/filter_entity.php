...
class FilterEntity
{
     ...
     *
     * @param FilterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FilterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Filter|array The loaded Filter as an assoc-array at the
     ...
     * Create a new Filter.
     *
     * @param FilterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FilterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Filter|array The created Filter as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param FilterUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FilterUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Filter|array The updated Filter as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Filter matching the given criteria.
     *
     * @param FilterRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FilterRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Filter|array The removed Filter as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
