...
// Pipedrive SDK OrganizationRelationship entity
...
class OrganizationRelationshipEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_relationship";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationRelationshipEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationRelationship|array $args OrganizationRelationship data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = PipedriveHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return OrganizationRelationship|array The current OrganizationRelationship data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationRelationship fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = PipedriveHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of OrganizationRelationship fields).
     */
    ...
    /**
     * Load a single OrganizationRelationship.
     *
     * @param OrganizationRelationshipLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationRelationshipLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationRelationship|array The loaded OrganizationRelationship as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = PipedriveHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List OrganizationRelationship items matching the given filter.
     *
     * @param OrganizationRelationshipListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationRelationship fields) as an assoc-array; OrganizationRelationshipListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationRelationship[]|array A list of OrganizationRelationship items as assoc-arrays at
     *   the SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new OrganizationRelationship.
     *
     * @param OrganizationRelationshipCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationRelationshipCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationRelationship|array The created OrganizationRelationship as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing OrganizationRelationship.
     *
     * @param OrganizationRelationshipUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationRelationshipUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationRelationship|array The updated OrganizationRelationship as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an OrganizationRelationship matching the given criteria.
     *
     * @param OrganizationRelationshipRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; OrganizationRelationshipRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationRelationship|array The removed OrganizationRelationship as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
