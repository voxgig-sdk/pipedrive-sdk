...
class NoteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NoteEntity($this->_client, $opts);
    }

    /**
     * @param Note|array $args Note data (assoc-array) to store.
     */
    ...
    /**
     * @return Note|array The current Note data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Note fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Note fields).
     */
     ...
     * Load a single Note.
     *
     * @param NoteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NoteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Note|array The loaded Note as an assoc-array at the
    ...
    /**
     * List Note items matching the given filter.
     *
     * @param NoteListMatch|array|null $reqmatch Match filter (any subset
     *   of Note fields) as an assoc-array; NoteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Note[]|array A list of Note items as assoc-arrays at
     ...
     * Create a new Note.
     *
     * @param NoteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NoteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Note|array The created Note as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param NoteUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NoteUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Note|array The updated Note as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Note matching the given criteria.
     *
     * @param NoteRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; NoteRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Note|array The removed Note as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
