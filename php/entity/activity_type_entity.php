...
// Pipedrive SDK ActivityType entity
...
class ActivityTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActivityTypeEntity($this->_client, $opts);
    }

    /**
     * @param ActivityType|array $args ActivityType data (assoc-array) to store.
     */
    ...
    /**
     * @return ActivityType|array The current ActivityType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActivityType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActivityType fields).
     */
    ...
    /**
     * List ActivityType items matching the given filter.
     *
     * @param ActivityTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of ActivityType fields) as an assoc-array; ActivityTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityType[]|array A list of ActivityType items as assoc-arrays at
     ...
     *
     * @param ActivityTypeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActivityTypeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityType|array The created ActivityType as an assoc-array at the
     ...
     *
     * @param ActivityTypeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActivityTypeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityType|array The updated ActivityType as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ActivityType matching the given criteria.
     *
     * @param ActivityTypeRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ActivityTypeRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityType|array The removed ActivityType as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
