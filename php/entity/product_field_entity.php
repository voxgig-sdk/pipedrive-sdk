...
// Pipedrive SDK ProductField entity
...
class ProductFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProductFieldEntity($this->_client, $opts);
    }

    /**
     * @param ProductField|array $args ProductField data (assoc-array) to store.
     */
    ...
    /**
     * @return ProductField|array The current ProductField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProductField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProductField fields).
     */
    ...
    /**
     * Load a single ProductField.
     *
     * @param ProductFieldLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProductFieldLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProductField|array The loaded ProductField as an assoc-array at the
    ...
    /**
     * List ProductField items matching the given filter.
     *
     * @param ProductFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of ProductField fields) as an assoc-array; ProductFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProductField[]|array A list of ProductField items as assoc-arrays at
    ...
    /**
     * Create a new ProductField.
     *
     * @param ProductFieldCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProductFieldCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProductField|array The created ProductField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ProductField.
     *
     * @param ProductFieldUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProductFieldUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProductField|array The updated ProductField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ProductField matching the given criteria.
     *
     * @param ProductFieldRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProductFieldRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProductField|array The removed ProductField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
