...
class GoalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GoalEntity($this->_client, $opts);
    }

    /**
     * @param Goal|array $args Goal data (assoc-array) to store.
     */
    ...
    /**
     * @return Goal|array The current Goal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Goal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Goal fields).
     */
     ...
     * Load a single Goal.
     *
     * @param GoalLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GoalLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Goal|array The loaded Goal as an assoc-array at the
     ...
     * Create a new Goal.
     *
     * @param GoalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GoalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Goal|array The created Goal as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param GoalUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GoalUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Goal|array The updated Goal as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Goal matching the given criteria.
     *
     * @param GoalRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; GoalRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Goal|array The removed Goal as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
