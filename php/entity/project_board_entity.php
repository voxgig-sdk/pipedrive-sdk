...
// Pipedrive SDK ProjectBoard entity
...
class ProjectBoardEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectBoardEntity($this->_client, $opts);
    }

    /**
     * @param ProjectBoard|array $args ProjectBoard data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectBoard|array The current ProjectBoard data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectBoard fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectBoard fields).
     */
    ...
    /**
     * Load a single ProjectBoard.
     *
     * @param ProjectBoardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectBoardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectBoard|array The loaded ProjectBoard as an assoc-array at the
    ...
    /**
     * List ProjectBoard items matching the given filter.
     *
     * @param ProjectBoardListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectBoard fields) as an assoc-array; ProjectBoardListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectBoard[]|array A list of ProjectBoard items as assoc-arrays at
