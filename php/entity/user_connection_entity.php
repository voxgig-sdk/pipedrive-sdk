...
// Pipedrive SDK UserConnection entity
...
class UserConnectionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserConnectionEntity($this->_client, $opts);
    }

    /**
     * @param UserConnection|array $args UserConnection data (assoc-array) to store.
     */
    ...
    /**
     * @return UserConnection|array The current UserConnection data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserConnection fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserConnection fields).
     */
    ...
    /**
     * Load a single UserConnection.
     *
     * @param UserConnectionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UserConnectionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserConnection|array The loaded UserConnection as an assoc-array at the
