...
// Pipedrive SDK OrganizationField entity
...
class OrganizationFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationFieldEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationField|array $args OrganizationField data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationField|array The current OrganizationField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationField fields).
     */
    ...
    /**
     * Load a single OrganizationField.
     *
     * @param OrganizationFieldLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OrganizationFieldLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationField|array The loaded OrganizationField as an assoc-array at the
    ...
    /**
     * List OrganizationField items matching the given filter.
     *
     * @param OrganizationFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of OrganizationField fields) as an assoc-array; OrganizationFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationField[]|array A list of OrganizationField items as assoc-arrays at
    ...
    /**
     * Create a new OrganizationField.
     *
     * @param OrganizationFieldCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationFieldCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationField|array The created OrganizationField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing OrganizationField.
     *
     * @param OrganizationFieldUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationFieldUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationField|array The updated OrganizationField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an OrganizationField matching the given criteria.
     *
     * @param OrganizationFieldRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; OrganizationFieldRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationField|array The removed OrganizationField as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
