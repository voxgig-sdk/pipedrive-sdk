...
class OauthEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OauthEntity($this->_client, $opts);
    }

    /**
     * @param Oauth|array $args Oauth data (assoc-array) to store.
     */
    ...
    /**
     * @return Oauth|array The current Oauth data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Oauth fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Oauth fields).
     */
     ...
     * Load a single Oauth.
     *
     * @param OauthLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OauthLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Oauth|array The loaded Oauth as an assoc-array at the
     ...
     * Create a new Oauth.
     *
     * @param OauthCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OauthCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Oauth|array The created Oauth as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
