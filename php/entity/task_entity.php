...
class TaskEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TaskEntity($this->_client, $opts);
    }

    /**
     * @param Task|array $args Task data (assoc-array) to store.
     */
    ...
    /**
     * @return Task|array The current Task data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Task fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Task fields).
     */
     ...
     * Load a single Task.
     *
     * @param TaskLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TaskLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Task|array The loaded Task as an assoc-array at the
    ...
    /**
     * List Task items matching the given filter.
     *
     * @param TaskListMatch|array|null $reqmatch Match filter (any subset
     *   of Task fields) as an assoc-array; TaskListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Task[]|array A list of Task items as assoc-arrays at
     ...
     * Create a new Task.
     *
     * @param TaskCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TaskCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Task|array The created Task as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
     ...
     *
     * @param TaskUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TaskUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Task|array The updated Task as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Task matching the given criteria.
     *
     * @param TaskRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TaskRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Task|array The removed Task as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
