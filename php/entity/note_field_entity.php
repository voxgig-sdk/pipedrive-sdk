...
// Pipedrive SDK NoteField entity
...
class NoteFieldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NoteFieldEntity($this->_client, $opts);
    }

    /**
     * @param NoteField|array $args NoteField data (assoc-array) to store.
     */
    ...
    /**
     * @return NoteField|array The current NoteField data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NoteField fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NoteField fields).
     */
    ...
    /**
     * List NoteField items matching the given filter.
     *
     * @param NoteFieldListMatch|array|null $reqmatch Match filter (any subset
     *   of NoteField fields) as an assoc-array; NoteFieldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NoteField[]|array A list of NoteField items as assoc-arrays at
