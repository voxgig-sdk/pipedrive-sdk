...
// Pipedrive SDK ProjectTemplate entity
...
class ProjectTemplateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectTemplateEntity($this->_client, $opts);
    }

    /**
     * @param ProjectTemplate|array $args ProjectTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectTemplate|array The current ProjectTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectTemplate fields).
     */
    ...
    /**
     * Load a single ProjectTemplate.
     *
     * @param ProjectTemplateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectTemplateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectTemplate|array The loaded ProjectTemplate as an assoc-array at the
    ...
    /**
     * List ProjectTemplate items matching the given filter.
     *
     * @param ProjectTemplateListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectTemplate fields) as an assoc-array; ProjectTemplateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectTemplate[]|array A list of ProjectTemplate items as assoc-arrays at
