...
// Pipedrive SDK LegacyTeam entity
...
class LegacyTeamEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LegacyTeamEntity($this->_client, $opts);
    }

    /**
     * @param LegacyTeam|array $args LegacyTeam data (assoc-array) to store.
     */
    ...
    /**
     * @return LegacyTeam|array The current LegacyTeam data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LegacyTeam fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LegacyTeam fields).
     */
    ...
    /**
     * Load a single LegacyTeam.
     *
     * @param LegacyTeamLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LegacyTeamLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyTeam|array The loaded LegacyTeam as an assoc-array at the
    ...
    /**
     * List LegacyTeam items matching the given filter.
     *
     * @param LegacyTeamListMatch|array|null $reqmatch Match filter (any subset
     *   of LegacyTeam fields) as an assoc-array; LegacyTeamListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyTeam[]|array A list of LegacyTeam items as assoc-arrays at
    ...
    /**
     * Create a new LegacyTeam.
     *
     * @param LegacyTeamCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LegacyTeamCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyTeam|array The created LegacyTeam as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing LegacyTeam.
     *
     * @param LegacyTeamUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LegacyTeamUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyTeam|array The updated LegacyTeam as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an LegacyTeam matching the given criteria.
     *
     * @param LegacyTeamRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; LegacyTeamRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyTeam|array The removed LegacyTeam as an assoc-array at the
     *   SDK boundary; throws PipedriveError on failure (item-5 convention).
     */
