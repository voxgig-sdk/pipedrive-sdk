...
// Pipedrive SDK ratelimit feature
...
class PipedriveRatelimitFeature extends PipedriveBaseFeature
{
    ...
    private function _acquire(PipedriveContext $ctx): void
    {
    ...
    private function _track(PipedriveContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
