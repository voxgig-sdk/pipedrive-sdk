...
class ActivityFieldEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActivityFieldEntity(self._client, opts)
    ...
    def data_get(self) -> ActivityField:
    ...
    def match_get(self) -> ActivityField:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ActivityField]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ActivityField().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
