...
from pipedrive_sdk.pipedrive_types import (
...
class OrganizationRelationshipEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationRelationshipEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationRelationship:
    ...
    def match_get(self) -> OrganizationRelationship:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OrganizationRelationship:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OrganizationRelationship().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OrganizationRelationship]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OrganizationRelationship().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: OrganizationRelationshipCreateData, ctrl=None) -> OrganizationRelationship:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: OrganizationRelationshipUpdateData, ctrl=None) -> OrganizationRelationship:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch=None, ctrl=None) -> OrganizationRelationship:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.OrganizationRelationship().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
