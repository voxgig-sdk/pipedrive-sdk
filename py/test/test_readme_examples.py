# Pipedrive SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PipedriveSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PipedriveSDK(...) and PipedriveSDK.test(...) become
#      PipedriveSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pipedrive_sdk"
_SDK_CLASS = "PipedriveSDK"
