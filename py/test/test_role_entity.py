    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set PIPEDRIVE_TEST_ROLE_ENTID JSON to run live")
        client = setup["client"]
        ...
        role_ref01_markdef_up0_value = "Mark01-role_ref01_" + str(setup["now"])
        role_ref01_data_up0_up[role_ref01_markdef_up0_name] = role_ref01_markdef_up0_value

        role_ref01_resdata_up0 = helpers.to_map(runner.entity_data(role_ref01_ent.update(role_ref01_data_up0_up, None)))
        assert role_ref01_resdata_up0 is not None
        assert role_ref01_resdata_up0["id"] == role_ref01_data_up0_up["id"]
        assert role_ref01_resdata_up0[role_ref01_markdef_up0_name] == role_ref01_markdef_up0_value
...
def _role_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("PIPEDRIVE_TEST_ROLE_ENTID"))
