...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/pipedrive` | publish pending — [install from git tag](https://github.com/voxgig-sdk/pipedrive-sdk/releases) |
| Python | `voxgig-sdk-pipedrive` | publish pending — [install from git tag](https://github.com/voxgig-sdk/pipedrive-sdk/releases) |
| PHP | `voxgig-sdk/pipedrive` | publish pending — [install from git tag](https://github.com/voxgig-sdk/pipedrive-sdk/releases) |
| Golang | `github.com/voxgig-sdk/pipedrive-sdk/go` | `go get github.com/voxgig-sdk/pipedrive-sdk/go@latest` |
| Lua | `voxgig-sdk-pipedrive` | publish pending — [install from git tag](https://github.com/voxgig-sdk/pipedrive-sdk/releases) |
| JavaScript | `@voxgig-sdk/pipedrive-js` | publish pending — [install from git tag](https://github.com/voxgig-sdk/pipedrive-sdk/releases) |
