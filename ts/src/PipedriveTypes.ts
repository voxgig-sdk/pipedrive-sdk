...
export interface DealLoadMatch {
  ...
  //   'permitted_user' | 'summary' | 'timeline'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface DealListMatch {
  ...
  //   'archived' | 'changelog' | 'file' | 'flow' | 'follower' | 'mail_message' | 'participant' | 'participants_changelog'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface DealCreateData {
  ...
  // Selects a custom action instead of the plain create:
  //   'duplicate' | 'follower' | 'participant'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface OrganizationListMatch {
  ...
  // Selects a custom action instead of the plain list:
  //   'changelog' | 'file' | 'flow' | 'follower' | 'mail_message' | 'permitted_user'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface PersonListMatch {
  ...
  // Selects a custom action instead of the plain list:
  //   'changelog' | 'file' | 'flow' | 'follower' | 'mail_message' | 'permitted_user' | 'product'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface PipelineLoadMatch {
  ...
  // Selects a custom action instead of the plain load:
  //   'conversion_statistic' | 'movement_statistic'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
...
export interface ProductListMatch {
  ...
  // Selects a custom action instead of the plain list:
  //   'deal' | 'file' | 'follower' | 'permitted_user'
  // The remaining keys are that action's own payload.
  $action?: string
  [action: string]: any
}
