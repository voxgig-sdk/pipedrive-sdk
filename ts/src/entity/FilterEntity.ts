...
class FilterEntity extends PipedriveEntityBase<Filter> {
  ...
  async load(this: any, reqmatch?: FilterLoadMatch, ctrl?: Control): Promise<FilterEntity> {
  ...
  async create(this: any, reqdata?: FilterCreateData, ctrl?: Control): Promise<FilterEntity> {
  ...
  async update(this: any, reqdata?: FilterUpdateData, ctrl?: Control): Promise<FilterEntity> {
  ...
  async remove(
    this: any, reqmatch?: FilterRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<FilterEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
