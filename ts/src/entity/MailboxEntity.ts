...
class MailboxEntity extends PipedriveEntityBase<Mailbox> {
  ...
  make(this: MailboxEntity) {
    return new MailboxEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: MailboxLoadMatch, ctrl?: Control): Promise<MailboxEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Mailbox> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: MailboxListMatch, ctrl?: Control): Promise<MailboxEntity[]> {
  ...
  async update(this: any, reqdata?: MailboxUpdateData, ctrl?: Control): Promise<MailboxEntity> {
  ...
  async remove(
    this: any, reqmatch?: MailboxRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<MailboxEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
