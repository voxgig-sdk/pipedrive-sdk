...
class TaskEntity extends PipedriveEntityBase<Task> {
  ...
  async list(this: any, reqmatch?: TaskListMatch, ctrl?: Control): Promise<TaskEntity[]> {
  ...
  async create(this: any, reqdata?: TaskCreateData, ctrl?: Control): Promise<TaskEntity> {
  ...
  async update(this: any, reqdata?: TaskUpdateData, ctrl?: Control): Promise<TaskEntity> {
  ...
  async remove(
    this: any, reqmatch?: TaskRemoveMatch, ctrl?: Control,
  ): Promise<TaskEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<TaskEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
