...
class ProductEntity extends PipedriveEntityBase<Product> {
  ...
  async create(this: any, reqdata?: ProductCreateData, ctrl?: Control): Promise<ProductEntity> {
  ...
  async remove(
    this: any, reqmatch?: ProductRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ProductEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
