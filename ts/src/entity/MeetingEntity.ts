...
class MeetingEntity extends PipedriveEntityBase<Meeting> {
  ...
  async create(this: any, reqdata?: MeetingCreateData, ctrl?: Control): Promise<MeetingEntity> {
  ...
  async remove(
    this: any, reqmatch?: MeetingRemoveMatch, ctrl?: Control,
