...
class PersonEntity extends PipedriveEntityBase<Person> {
  ...
  async create(this: any, reqdata?: PersonCreateData, ctrl?: Control): Promise<PersonEntity> {
  ...
  async update(this: any, reqdata?: PersonUpdateData, ctrl?: Control): Promise<PersonEntity> {
  ...
  async remove(
    this: any, reqmatch?: PersonRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PersonEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
