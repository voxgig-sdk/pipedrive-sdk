...
class CallLogEntity extends PipedriveEntityBase<CallLog> {
  ...
  make(this: CallLogEntity) {
    return new CallLogEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: CallLogLoadMatch, ctrl?: Control): Promise<CallLogEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<CallLog> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: CallLogListMatch, ctrl?: Control): Promise<CallLogEntity[]> {
  ...
  async create(this: any, reqdata?: CallLogCreateData, ctrl?: Control): Promise<CallLogEntity> {
  ...
  async remove(
    this: any, reqmatch?: CallLogRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CallLogEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
