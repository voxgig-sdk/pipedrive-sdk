...
class DealEntity extends PipedriveEntityBase<Deal> {
  ...
  async load(this: any, reqmatch?: DealLoadMatch, ctrl?: Control): Promise<DealEntity> {
  ...
  async create(this: any, reqdata?: DealCreateData, ctrl?: Control): Promise<DealEntity> {
  ...
  async update(this: any, reqdata?: DealUpdateData, ctrl?: Control): Promise<DealEntity> {
  ...
  async remove(
    this: any, reqmatch?: DealRemoveMatch, ctrl?: Control,
  ): Promise<DealEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<DealEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
