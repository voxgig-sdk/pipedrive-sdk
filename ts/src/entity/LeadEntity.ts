...
class LeadEntity extends PipedriveEntityBase<Lead> {
  ...
  make(this: LeadEntity) {
    return new LeadEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: LeadLoadMatch, ctrl?: Control): Promise<LeadEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Lead> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: LeadCreateData, ctrl?: Control): Promise<LeadEntity> {
  ...
  async update(this: any, reqdata?: LeadUpdateData, ctrl?: Control): Promise<LeadEntity> {
  ...
  async remove(
    this: any, reqmatch?: LeadRemoveMatch, ctrl?: Control,
  ): Promise<LeadEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<LeadEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
