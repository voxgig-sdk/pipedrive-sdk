...
class GoalEntity extends PipedriveEntityBase<Goal> {
  ...
  make(this: GoalEntity) {
    return new GoalEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GoalLoadMatch, ctrl?: Control): Promise<GoalEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Goal> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: GoalCreateData, ctrl?: Control): Promise<GoalEntity> {
  ...
  async update(this: any, reqdata?: GoalUpdateData, ctrl?: Control): Promise<GoalEntity> {
  ...
  async remove(
    this: any, reqmatch?: GoalRemoveMatch, ctrl?: Control,
  ): Promise<GoalEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<GoalEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
