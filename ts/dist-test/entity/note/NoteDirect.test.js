...
(0, node_test_1.describe)('NoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-note', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-note', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["comment01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-note', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-note', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_NOTE_ENTID'];
...
//# sourceMappingURL=NoteDirect.test.js.map