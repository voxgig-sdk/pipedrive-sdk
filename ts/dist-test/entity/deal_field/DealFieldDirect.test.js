...
(0, node_test_1.describe)('DealFieldDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-deal_field', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-deal_field', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-deal_field', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-deal_field', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_DEAL_FIELD_ENTID'];
...
//# sourceMappingURL=DealFieldDirect.test.js.map