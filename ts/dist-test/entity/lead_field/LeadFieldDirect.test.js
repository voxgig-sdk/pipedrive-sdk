...
(0, node_test_1.describe)('LeadFieldDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-lead_field', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-lead_field', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_LEAD_FIELD_ENTID'];
...
//# sourceMappingURL=LeadFieldDirect.test.js.map