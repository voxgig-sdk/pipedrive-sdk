...
(0, node_test_1.describe)('LeadFieldEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'lead_field.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/lead_field/LeadFieldTestData.json');
    ...
    let idmap = transform(['lead_field01', 'lead_field02', 'lead_field03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=LeadFieldEntity.test.js.map