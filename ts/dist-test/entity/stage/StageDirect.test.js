...
(0, node_test_1.describe)('StageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-stage', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-stage', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["stage01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_STAGE_ENTID'];
...
//# sourceMappingURL=StageDirect.test.js.map