...
(0, node_test_1.describe)('ProjectBoardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-project_board', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-project_board', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-project_board', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-project_board', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_PROJECT_BOARD_ENTID'];
...
//# sourceMappingURL=ProjectBoardDirect.test.js.map