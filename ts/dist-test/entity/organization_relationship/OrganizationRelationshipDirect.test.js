...
(0, node_test_1.describe)('OrganizationRelationshipDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-organization_relationship', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-organization_relationship', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-organization_relationship', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-organization_relationship', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_ORGANIZATION_RELATIONSHIP_ENTID'];
...
//# sourceMappingURL=OrganizationRelationshipDirect.test.js.map