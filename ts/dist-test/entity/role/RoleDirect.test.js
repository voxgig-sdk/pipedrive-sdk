...
(0, node_test_1.describe)('RoleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-role', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-role', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-role', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-role', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["role01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_ROLE_ENTID'];
...
//# sourceMappingURL=RoleDirect.test.js.map