...
(0, node_test_1.describe)('OauthDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-oauth', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-oauth', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_OAUTH_ENTID'];
...
//# sourceMappingURL=OauthDirect.test.js.map