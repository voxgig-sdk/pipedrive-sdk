...
(0, node_test_1.describe)('MailboxDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-mailbox', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-mailbox', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-mailbox', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-mailbox', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_MAILBOX_ENTID'];
...
//# sourceMappingURL=MailboxDirect.test.js.map