...
(0, node_test_1.describe)('UserConnectionEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_connection/UserConnectionTestData.json');
    ...
    let idmap = transform(['user_connection01', 'user_connection02', 'user_connection03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=UserConnectionEntity.test.js.map