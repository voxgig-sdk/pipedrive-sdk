...
(0, node_test_1.describe)('ActivityFieldDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-activity_field', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-activity_field', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_ACTIVITY_FIELD_ENTID'];
...
//# sourceMappingURL=ActivityFieldDirect.test.js.map