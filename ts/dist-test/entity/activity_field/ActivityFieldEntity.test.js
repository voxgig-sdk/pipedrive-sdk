...
(0, node_test_1.describe)('ActivityFieldEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/activity_field/ActivityFieldTestData.json');
    ...
    let idmap = transform(['activity_field01', 'activity_field02', 'activity_field03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['PIPEDRIVE_TEST_ACTIVITY_FIELD_ENTID'];
    const live = 'TRUE' === env.PIPEDRIVE_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['PIPEDRIVE_TEST_ACTIVITY_FIELD_ENTID'];
...
//# sourceMappingURL=ActivityFieldEntity.test.js.map