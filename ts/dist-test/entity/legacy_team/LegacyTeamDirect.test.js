...
(0, node_test_1.describe)('LegacyTeamDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-legacy_team', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-legacy_team', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-legacy_team', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-legacy_team', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_LEGACY_TEAM_ENTID'];
...
//# sourceMappingURL=LegacyTeamDirect.test.js.map