...
(0, node_test_1.describe)('PipelineDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-pipeline', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-pipeline', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-pipeline', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-pipeline', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["pipeline01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_PIPELINE_ENTID'];
...
//# sourceMappingURL=PipelineDirect.test.js.map