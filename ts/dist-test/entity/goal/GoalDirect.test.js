...
(0, node_test_1.describe)('GoalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-goal', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-goal', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PIPEDRIVE_TEST_GOAL_ENTID'];
...
//# sourceMappingURL=GoalDirect.test.js.map