...
const TEST_SEED = { "entity": { "activity_field": { "test01": { "id": "test01" } }, "activity_type": { "test01": { "id": "test01" } }, "billing": { "test01": { "id": "test01" } }, "call_log": { "test01": { "id": "test01" } }, "channel": { "test01": { "id": "test01" } }, "currency": { "test01": { "id": "test01" } }, "deal": { "test01": { "id": "test01" } }, "deal_field": { "test01": { "id": "test01" } }, "file": { "test01": { "id": "test01" } }, "filter": { "test01": { "id": "test01" } }, "goal": { "test01": { "id": "test01" } }, "lead": { "test01": { "id": "test01" } }, "lead_field": { "test01": { "id": "test01" } }, "lead_label": { "test01": { "id": "test01" } }, "lead_source": { "test01": { "id": "test01" } }, "legacy_team": { "test01": { "id": "test01" } }, "mailbox": { "test01": { "id": "test01" } }, "meeting": { "test01": { "id": "test01" } }, "note": { "test01": { "id": "test01" } }, "note_field": { "test01": { "id": "test01" } }, "oauth": { "test01": { "id": "test01" } }, "organization": { "test01": { "id": "test01" } }, "organization_field": { "test01": { "id": "test01" } }, "organization_relationship": { "test01": { "id": "test01" } }, "permission_set": { "test01": { "id": "test01" } }, "person": { "test01": { "id": "test01" } }, "person_field": { "test01": { "id": "test01" } }, "pipeline": { "test01": { "id": "test01" } }, "product": { "test01": { "id": "test01" } }, "product_field": { "test01": { "id": "test01" } }, "project": { "test01": { "id": "test01" } }, "project_board": { "test01": { "id": "test01" } }, "project_phase": { "test01": { "id": "test01" } }, "project_template": { "test01": { "id": "test01" } }, "recent": { "test01": { "id": "test01" } }, "role": { "test01": { "id": "test01" } }, "stage": { "test01": { "id": "test01" } }, "task": { "test01": { "id": "test01" } }, "user": { "test01": { "id": "test01" } }, "user_connection": { "test01": { "id": "test01" } }, "user_setting": { "test01": { "id": "test01" } }, "webhook": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+PipedriveSDK\b/.test(code) ||
        /\bPipedriveSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+PipedriveSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/PipedriveSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
