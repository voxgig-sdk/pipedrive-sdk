...
function envOverride(m) {
    if ('TRUE' === process.env.PIPEDRIVE_TEST_LIVE ||
        'TRUE' === process.env.PIPEDRIVE_TEST_OVERRIDE) {
    ...
    m.PIPEDRIVE_TEST_EXPLAIN = process.env.PIPEDRIVE_TEST_EXPLAIN || m.PIPEDRIVE_TEST_EXPLAIN;
    return m;
}
