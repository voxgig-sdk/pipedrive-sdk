...
// Pipedrive SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PipedriveTestFeature extends PipedriveBaseFeature
{
    ...
    public function init(PipedriveContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PipedriveContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PipedriveParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PipedriveContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PipedriveContext $ctx, $op, $args): array
    {
