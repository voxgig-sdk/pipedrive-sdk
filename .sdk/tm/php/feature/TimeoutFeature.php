...
class PipedriveTimeoutFeature extends PipedriveBaseFeature
{
    ...
    private function _with_timeout(PipedriveContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PipedriveContext $_ctx, float $ms): void
    {
        $client = $this->client;
