...
class PipedrivePagingFeature extends PipedriveBaseFeature
{
    ...
    private function _graphql_pre_request(PipedriveContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(PipedriveContext $ctx): bool
    {
