...
from projectname_sdk import PipedriveSDK
from projectname_sdk.core.spec import PipedriveSpec
from projectname_sdk.core.result import PipedriveResult
from projectname_sdk.core.response import PipedriveResponse
from projectname_sdk.core.operation import PipedriveOperation
from projectname_sdk.core.error import PipedriveError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import PipedriveBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return PipedriveError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = PipedriveSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = PipedriveSDK.test(None, None)
        ...
        class TestInitFeature(PipedriveBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PipedriveBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PipedriveSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PipedriveSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PipedriveSDK.test(None, setup_opts)
