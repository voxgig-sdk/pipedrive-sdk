...
class PipedriveTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PipedriveTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PipedriveTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PipedriveTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
