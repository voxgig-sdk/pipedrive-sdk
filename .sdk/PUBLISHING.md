...
|---|---|---|
| `js/` | @voxgig-sdk/pipedrive-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/pipedrive | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/pipedrive-js \
      --repository voxgig-sdk/pipedrive-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/pipedrive-js` shows it, and
`npm trust revoke @voxgig-sdk/pipedrive-js --id=<id>` removes it.
